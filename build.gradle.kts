...
val zuulOssVersion = "3.2.7"
val log4jVersion = "2.25.2"

dependencies {
    jmh("io.projectreactor.netty:reactor-netty-http:1.2.11")
    jmh("org.springframework:spring-web:6.2.12")
    jmh("com.fasterxml.jackson.core:jackson-databind:2.20.1")
