...
val zuulOssVersion = "2.5.11"
val log4jVersion = "2.24.1"

dependencies {
    jmh("io.projectreactor.netty:reactor-netty-http:1.1.23")
    jmh("org.springframework:spring-web:6.1.14")
    ...
    jmh("com.github.luben:zstd-jni:1.5.6-7")
