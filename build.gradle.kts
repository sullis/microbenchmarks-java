...
val brotli4jVersion = "1.19.0"
val nettyVersion = "4.2.4.Final"
val netty5Version = "5.0.0.Alpha5"
val zuulOssVersion = "3.1.4"
val log4jVersion = "2.25.1"

dependencies {
    jmh("io.projectreactor.netty:reactor-netty-http:1.2.9")
    jmh("org.springframework:spring-web:6.2.10")
    jmh("com.fasterxml.jackson.core:jackson-databind:2.19.2")
    ...
    jmh("com.github.luben:zstd-jni:1.5.7-4")
