...
val zuulOssVersion = "2.6.3"
val log4jVersion = "2.24.3"

dependencies {
    jmh("io.projectreactor.netty:reactor-netty-http:1.2.3")
    jmh("org.springframework:spring-web:6.2.3")
    ...
    jmh("com.github.luben:zstd-jni:1.5.6-10")
